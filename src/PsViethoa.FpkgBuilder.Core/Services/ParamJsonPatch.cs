...
public readonly record struct ParamJsonPatchOptions(bool ForceStandardDrm, bool ClearVersionFileUri, bool ClearPlayGoAttributes)
{
    ...
    public bool Any => ForceStandardDrm || ClearVersionFileUri || ClearPlayGoAttributes;
}
